...
func Repos_update_pull_request_review_protectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_update_pull_request_review_protectionTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_update_pull_request_review_protectionHandler(cfg),
	}
}
