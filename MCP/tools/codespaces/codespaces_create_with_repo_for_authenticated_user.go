...
func Codespaces_create_with_repo_for_authenticated_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodespaces_create_with_repo_for_authenticated_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repos_owner_repo_codespaces",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_create_with_repo_for_authenticated_userHandler(cfg),
	}
}
