...
func Codespaces_create_or_update_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/codespaces/secrets/%s%s", cfg.BaseURL, org, secret_name, queryString)
...
func CreateCodespaces_create_or_update_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_codespaces_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_create_or_update_org_secretHandler(cfg),
	}
}
