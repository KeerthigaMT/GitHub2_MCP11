...
func Dependency_graph_create_repository_snapshotHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDependency_graph_create_repository_snapshotTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repos_owner_repo_dependency-graph_snapshots",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependency_graph_create_repository_snapshotHandler(cfg),
	}
}
